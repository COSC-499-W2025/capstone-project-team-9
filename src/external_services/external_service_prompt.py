...
│                                                                         │
│  ⚠️  YOUR DATA WILL BE SENT TO EXTERNAL PROVIDERS:                     │
...
│                                                                         │
│  ⚠️  CONSIDER BEFORE GRANTING PERMISSION:                              │
...
ℹ️  NOTE: You can change this preference at any time in the settings.
...
def request_external_service_permission(user_id='default_user', service_name='LLM'):
    """
    ...
    # If permission already exists, inform user and return
    if existing_permission is not None:
        if existing_permission:
            print(f"\nℹ️  External {service_name} service: Permission already GRANTED")
            print("   Enhanced analysis is enabled for your projects.")
        else:
            print(f"\nℹ️  External {service_name} service: Permission previously DECLINED")
            print("   Local analysis will be used (your data stays private).")
        
        # Ask if they want to change it
        change = input("\nDo you want to change this setting? (yes/no): ").strip().lower()
