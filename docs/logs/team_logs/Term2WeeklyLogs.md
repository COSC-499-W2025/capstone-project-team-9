...
### **Ryan**
### What I completed this week
- We had the group presentaion on monday which went qute well. we had some problem with a questions, but overall i think it went well
- on top of this i complted a makor change on the front end. It now matches our end goal figma prototype and looks much better
### Link to PR
- This is the link to the PR that i have made: https://github.com/COSC-499-W2025/capstone-project-team-9/pull/344
### What went well
- The coding went really well. This was a good week to coomplete the final requirement. It was partially compelted but needed the final push.
   We presented well and did not go too far over time. 
### what didnt go well
- There were some problems with the questions in the presentation, and we also did not do much coding as it was a presentation week
### what i will work on next week
- I will continue to develop the front end and will start to work on milestone three more thouroughly
---
### **Collaboration Highlights** 
...
### **Sami**
What I completed this week
Implemented new functionality in a separate feature branch and modified existing files to integrate the new logic with the current system. I also fixed minor issues, improved the code structure, and tested the changes to ensure they worked correctly with existing features before submitting a pull request for team review and safe merging.

Link to PR

This is the link to the PRs that i have made: #345
What went well
Figured out how to share the API keys which was good and we finally have a plan for the frontend
what didnt go well
Have found some bugs in terms of functionality implementation from the last couple of milestones.
what i will work on next week
Need to work on finalizing frontend decisions it's mostly done for now but it can be improved and we need to work on figuring out a game plan for whos going to implement what
...
- I reviewed the pull requests of four team members the last two weeks
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/351 for jinxi
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/352 for ryan




### My Plan for next week
- I need to sort out some of the bugs for the portfolio and then get those transferred over to the public dashboard.
...
### **Ryan**
### What I completed this week
- This week i prepared for the midterm and studied our system
- I wrote a pr that connects the backend of ranking projects to the frontend
- i updated the view of the rnaking systems
### Link to PR
...
### What went well
- the oding went well, We are making strong progess towards our final system, we just need to make our meetings more in sync and ensure that we are all on the same page
### what didnt go well
- This was a hard week as there was some midterms that took place including the one for this 
### what i will work on next week
- I will continue to develop the front end and will start to work on milestone three more thouroughly
...
| Reviewer | Reviewee | Focus Area |
|-----------|-----------|-------------|
| **Sami** | **Ryan** |  fixed ranking and summary https://github.com/COSC-499-W2025/capstone-project-team-9/pull/352|
| **Sami** | **Kevin** | Implement global error toast notification UI https://github.com/COSC-499-W2025/capstone-project-team-9/pull/354|
...
- **Details:** - **Resolved API Server Freeze Bug:** Diagnosed and fixed a critical issue where the FastAPI server would completely hang when a user attempted to generate a resume from the frontend dashboard. The legacy CLI code in `resume_manager.py` was executing an `input()` prompt, waiting for terminal input that the web browser could not provide. 
  ...
  - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/374
...
### Link to PR
- https://github.com/COSC-499-W2025/capstone-project-team-9/pull/372
- https://github.com/COSC-499-W2025/capstone-project-team-9/pull/368
### What went well
- The whole project went pretty well this week we spent a lot of our time focused on making everything look good for the peer evaluation which in turn got our whole thing near completion.
### what didnt go well
- Tons of bugs, and merge conflicts. Something that we've noticed is that our entire frontend is in a file called dashboard.html. We'd love to split this up but the refactor would be huge and with the grading restrictions... it doesn't really matter. 
### what i will work on next week
- Working on mielstone 3 presentations and finalizing our projects frontend and everything. Potentially SupaBase!
---
...
### This Sprints Progress
- I wrote the code for pull requests 367, 371 and 373
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/367
        - This bug fixed the portfolio generation and loading
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/371
        - This fixed it for the public portfolios
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/373
        - This fixes the resume viewing and exporting

- I reviewed the pull requests of four team members the last two weeks
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/358 for sami
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/359 for sami
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/360 for ryan
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/368 for sami
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/369 for ryan
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/370 for sami
    - https://github.com/COSC-499-W2025/capstone-project-team-9/pull/377 for ryan




### My Plan for next week
- I dont really have much as our project is now complete

### Reflection
I think we did a great job of finishing our project this week however the workload  was not evenly distributed this week.
---
...
### what didnt go well
- as there was a lot of prs this week we had a few bugs that needed to be fixed, and there were a few merge conflicts that occured
### what i will work on next week
- Next week we will work on all the finishing touched, and finalizing our project. we will also work on the presentation for milestone 3
...
| Reviewer | Reviewee | Focus Area |
|-----------|-----------|-------------|
| **Sami** | **Ryan** | https://github.com/COSC-499-W2025/capstone-project-team-9/pull/377 |
| **Sami** | **Ryan** | https://github.com/COSC-499-W2025/capstone-project-team-9/pull/369 |
...
### **Sami**
## Term 2 week 11
There is no team evaluation
### What I completed this week
- This week I finalized our résumé feature and reworked some of the front end so that it made more sense in terms of logic and actual wording.
- additionally this week I implemented a replay feature, which shows you past history of repose and as well as interview bullet points, which gives you stuff to talk about during interviews
### Link to PR
- This is the link to the PR that i have made: https://github.com/COSC-499-W2025/capstone-project-team-9/pull/385
- https://github.com/COSC-499-W2025/capstone-project-team-9/pull/379
- https://github.com/COSC-499-W2025/capstone-project-team-9/pull/378
### What went well
- our project is pretty much complete so there isn't anything that isn't necessarily or bad per se this week we finalized our résumé, which was the most important thing we needed to do
### what didnt go well
- we noticed that our project was running pretty slow due to some backlog and functions. We try to fix as much as we can still as a work in progress.
### what i will work on next week
- this next week is gonna be finalizing everything and potentially looking at hosting some of our back end or maybe even the front end
...
### **Ryan**
### What I completed this week
- This week There was not much communication between the group as we were all quite busy and we are nearly done all of this project
- i refined our testing and added testing for our static front end
### Link to PR
- This is the link to the PR that i have made: https://github.com/COSC-499-W2025/capstone-project-team-9/pull/384
### What went well
...
### what i will work on next week
- I will work on the video presentation and putting th final touches in the the front end ensuring that all code works and that there are no silly edge cases that catch us by suprise.
...
### What I completed this week
- This week There was not much communication between the group as we were all quite busy and we are nearly done all of this project
- I solved 2 bugs which were very time consuming to find and in addition to this i added testing
- we are basically done everyhting so we are just adding the fine touches to everything
### Link to PR
